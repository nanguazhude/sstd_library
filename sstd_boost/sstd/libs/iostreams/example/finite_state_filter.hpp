...
#include <locale>
#include <string>
#include <sstd/boost/config.hpp>                 // JOIN, member template friends.
...
#include <sstd/boost/iostreams/checked_operations.hpp>   // put_if.
#include <sstd/boost/iostreams/concepts.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp>           // openmode.
#include <sstd/boost/iostreams/filter/stdio.hpp>
