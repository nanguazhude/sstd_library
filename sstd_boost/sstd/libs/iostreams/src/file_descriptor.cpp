...
// Define BOOST_IOSTREAMS_SOURCE so that <sstd/boost/iostreams/detail/config.hpp>
...
#include <sstd/boost/config.hpp>                       // BOOST_JOIN
#include <sstd/boost/iostreams/detail/error.hpp>
#include <sstd/boost/iostreams/detail/config/dyn_link.hpp>
#include <sstd/boost/iostreams/detail/config/rtl.hpp>  // BOOST_IOSTREAMS_FD_XXX
#include <sstd/boost/iostreams/detail/config/windows_posix.hpp>
#include <sstd/boost/iostreams/detail/system_failure.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp>         // openmodes, failure.
#include <sstd/boost/iostreams/device/file_descriptor.hpp>
