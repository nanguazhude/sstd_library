...
#include "sstd/boost/context/continuation_ucontext.hpp"
#elif defined(BOOST_USE_WINFIB)
#include "sstd/boost/context/continuation_winfib.hpp"
#else
#include "sstd/boost/context/execution_context.hpp"
#endif
