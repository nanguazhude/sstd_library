...
// BOOST_TYPE_INDEX_USER_TYPEINDEX must be defined *BEFORE* first inclusion of <sstd/boost/type_index.hpp>
#define BOOST_TYPE_INDEX_USER_TYPEINDEX <sstd/boost/../libs/type_index/examples/user_defined_typeinfo.hpp>
