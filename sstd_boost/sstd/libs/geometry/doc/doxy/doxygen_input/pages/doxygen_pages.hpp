...
- \#include <sstd/boost/geometry/geometry.hpp> It is recommended to include this file.
...
- \#include <sstd/boost/geometry/geometries/geometries.hpp> This includes all default geometries: point, linestring,
...
- \#include <sstd/boost/geometry/geometries/cartesian2d.hpp> This includes all 2D Cartesian geometries: point_2d, linestring_2d,
...
- \#include <sstd/boost/geometry/geometries/register/point.hpp> macro's for point registration
- \#include <sstd/boost/geometry/geometries/register/box.hpp> macro's for box registration
...
- \#include <sstd/boost/geometry/extensions/gis/geographic/strategies/andoyer.hpp> for Andoyer distance calculations
- \#include <sstd/boost/geometry/extensions/gis/geographic/strategies/vincenty.hpp> for Vincenty distance calculations

If you want to use the \b projections:
- \#include <sstd/boost/geometry/extensions/gis/projections/parameters.hpp>
- \#include <sstd/boost/geometry/extensions/gis/projections/projection.hpp>
- \#include <sstd/boost/geometry/extensions/gis/projections/factory.hpp>

If you want to use the \b circle (n-sphere)
- \#include <sstd/boost/geometry/extensions/nsphere/...> <i>Several headerfiles, there is not yet a common include</i>
