...
//#  include <sstd/boost/test/included/prg_exec_monitor.hpp>
...
#  include <sstd/boost/geometry/extensions/contrib/ttmath_stub.hpp>
#endif

#if defined(HAVE_CLN) || defined(HAVE_GMP)
#  include <sstd/boost/numeric_adaptor/numeric_adaptor.hpp>
#endif


#if defined(HAVE_GMP)
#  include <sstd/boost/numeric_adaptor/gmp_value_type.hpp>
#endif
#if defined(HAVE_CLN)
#  include <sstd/boost/numeric_adaptor/cln_value_type.hpp>
#endif
