...
(`<sstd/boost/hana/ext/std/integral_constant.hpp>`) when using type traits from
...
`hana::traits` namespace, and they live in the `<sstd/boost/hana/traits.hpp>` header:
...
`hana::traits::declval` _lifted metafunction_ from the `<sstd/boost/hana/traits.hpp>`
...
in `<sstd/boost/hana/ext/std/integral_constant.hpp>` must be included.
...
of each library. For example, for Hana this means the `<sstd/boost/hana.hpp>` header,
