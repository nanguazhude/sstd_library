...
int cpp_main(int argc, char* argv[])
{
   ...
   const char* boost_include_expression = "^[ \t]*#[ \t]*include[ \t]+(\"sstd/boost/[^\"]+\"|<boost/[^>]+>)";
   ...
   test_search(function_with_body_expression, file_contents.c_str(), true, "sstd/boost/multiprecision/number.hpp");
   test_search(brace_expression, file_contents.c_str(), true, "sstd/boost/multiprecision/number.hpp");
   test_search(call_expression, file_contents.c_str(), true, "sstd/boost/multiprecision/number.hpp");
   test_search(highlight_expression, file_contents.c_str(), true, "sstd/boost/multiprecision/number.hpp");
   test_search(class_expression, file_contents.c_str(), true, "sstd/boost/multiprecision/number.hpp");
   test_search(include_expression, file_contents.c_str(), true, "sstd/boost/multiprecision/number.hpp");
   test_search(boost_include_expression, file_contents.c_str(), true, "sstd/boost/multiprecision/number.hpp");
