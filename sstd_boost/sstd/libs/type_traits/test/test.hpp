...
//#define TYPE_TRAITS(x) BOOST_STRINGIZE(sstd/boost/type_traits/x.hpp)
//#define TYPE_COMPARE(x) BOOST_STRINGIZE(sstd/boost/type_traits/x.hpp)
//#define TYPE_TRANSFORM(x) BOOST_STRINGIZE(sstd/boost/type_traits/x.hpp)
