...
//
#include <sstd/boost/gil/dynamic_step.hpp>
#include <sstd/boost/gil/color_base.hpp> // kth_element_type
#include <sstd/boost/gil/pixel.hpp> // kth_element_type
#include <sstd/boost/gil/pixel_iterator.hpp>
#include <sstd/boost/gil/pixel_iterator_adaptor.hpp>
#include <sstd/boost/gil/planar_pixel_iterator.hpp> // kth_element_type
#include <sstd/boost/gil/planar_pixel_reference.hpp> // kth_element_type
