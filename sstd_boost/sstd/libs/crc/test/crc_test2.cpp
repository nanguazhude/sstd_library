...
#include <sstd/boost/crc.hpp>   // for boost::crc_basic,crc_optimal,augmented_crc,crc

#include <sstd/boost/cstdint.hpp>         // for boost::uint16_t, uint32_t, uintmax_t
#include <sstd/boost/predef/other/endian.h>
#include <sstd/boost/integer.hpp>                                // for boost::uint_t
#include <sstd/boost/typeof/typeof.hpp>                             // for BOOST_AUTO
