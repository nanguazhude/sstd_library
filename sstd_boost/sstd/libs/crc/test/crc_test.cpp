...
#include <sstd/boost/config.hpp>                      // for BOOST_MSVC, etc.
#include <sstd/boost/crc.hpp>                         // for boost::crc_basic, etc.
#include <sstd/boost/cstdint.hpp>                     // for boost::uint16_t, etc.
#include <sstd/boost/cstdlib.hpp>                     // for boost::exit_success
#include <sstd/boost/integer.hpp>                     // for boost::uint_t
#include <sstd/boost/random/linear_congruential.hpp>  // for boost::minstd_rand
#include <sstd/boost/core/lightweight_test.hpp>
#include <sstd/boost/timer.hpp>                       // for boost::timer
