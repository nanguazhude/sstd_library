...
#include <sstd/boost/mpl/lambda.hpp> // #including this first is an intel6 workaround

#include <sstd/boost/python/object/class.hpp>
#include <sstd/boost/python/object/instance.hpp>
#include <sstd/boost/python/object/class_detail.hpp>
#include <sstd/boost/python/scope.hpp>
#include <sstd/boost/python/converter/registry.hpp>
#include <sstd/boost/python/object/find_instance.hpp>
#include <sstd/boost/python/object/pickle_support.hpp>
#include <sstd/boost/python/detail/map_entry.hpp>
#include <sstd/boost/python/object.hpp>
#include <sstd/boost/python/object_protocol.hpp>
#include <sstd/boost/detail/binary_search.hpp>
#include <sstd/boost/python/self.hpp>
#include <sstd/boost/python/dict.hpp>
#include <sstd/boost/python/str.hpp>
#include <sstd/boost/python/ssize_t.hpp>
#include <functional>
#include <vector>
#include <cstddef>
#include <new>
