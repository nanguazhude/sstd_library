...
#include <sstd/boost/math/tools/test.hpp> // for real_concept
#include <sstd/boost/math/concepts/real_concept.hpp> // for real_concept
using ::boost::math::concepts::real_concept;

#include <sstd/boost/math/distributions/chi_squared.hpp> // for chi_squared_distribution
#include <sstd/boost/math/distributions/non_central_chi_squared.hpp> // for chi_squared_distribution
using boost::math::chi_squared_distribution;
using boost::math::chi_squared;

#define BOOST_TEST_MAIN
#include <sstd/boost/test/unit_test.hpp> // for test_main
#include <sstd/boost/test/floating_point_comparison.hpp> // for BOOST_CHECK_CLOSE
