...
#include <sstd/boost/cstdfloat.hpp> // For float_64_t, float128_t. Must be first include!
#endif // #ifdef #ifdef BOOST_MATH_TEST_FLOAT128
// Needs gnu++17 for BOOST_HAS_FLOAT128
#include <sstd/boost/config.hpp>   // for BOOST_MSVC definition etc.
#include <sstd/boost/version.hpp>   // for BOOST_MSVC versions.

// Boost macros
#define BOOST_TEST_MAIN
#define BOOST_LIB_DIAGNOSTIC "on" // Report library file details.
#include <sstd/boost/test/included/unit_test.hpp> // Boost.Test
// #include <sstd/boost/test/unit_test.hpp> // Boost.Test
...
#include <sstd/boost/multiprecision/cpp_dec_float.hpp> // boost::multiprecision::cpp_dec_float_50
...
#include <sstd/boost/multiprecision/float128.hpp>
...
//#include <sstd/boost/fixed_point/fixed_point.hpp> // If available.

#include <sstd/boost/math/concepts/real_concept.hpp> // for real_concept tests.
#include <sstd/boost/math/special_functions/fpclassify.hpp> // isnan, ifinite.
#include <sstd/boost/math/special_functions/next.hpp> // float_next, float_prior
using boost::math::float_next;
using boost::math::float_prior;
#include <sstd/boost/math/special_functions/ulp.hpp>  // ulp

#include <sstd/boost/math/tools/test_value.hpp>  // for create_test_value and macro BOOST_MATH_TEST_VALUE.
#include <sstd/boost/math/policies/policy.hpp>
using boost::math::policies::digits2;
using boost::math::policies::digits10;
#include <sstd/boost/math/special_functions/lambert_w.hpp> // For Lambert W lambert_w function.
