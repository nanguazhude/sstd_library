...
#include <sstd/boost/math/tools/test.hpp>
#include <sstd/boost/math/concepts/real_concept.hpp> // for real_concept
#include <sstd/boost/math/distributions/normal.hpp> // for normal_distribution
  using boost::math::normal; // Default type double.
  using boost::math::normal_distribution; // All floating-point types.
#include <sstd/boost/math/distributions/cauchy.hpp> // for cauchy_distribution
  using boost::math::cauchy;
#include <sstd/boost/math/distributions/pareto.hpp> // for cauchy_distribution
  using boost::math::pareto;
#include <sstd/boost/math/distributions/find_scale.hpp>
...
#include <sstd/boost/test/unit_test.hpp> // for test_main
#include <sstd/boost/test/floating_point_comparison.hpp> // for BOOST_CHECK_CLOSE_FRACTION, BOOST_CHECK_EQUAL...
