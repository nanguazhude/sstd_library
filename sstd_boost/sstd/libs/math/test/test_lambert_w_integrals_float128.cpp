...
#include <sstd/boost/math/constants/constants.hpp> // for integral tests.
#include <sstd/boost/math/quadrature/tanh_sinh.hpp> // for integral tests.
#include <sstd/boost/math/quadrature/exp_sinh.hpp> // for integral tests.
