...
#include <sstd/boost/math/distributions/negative_binomial.hpp> // for negative_binomial_distribution
  using boost::math::negative_binomial_distribution; // default type is double.
  using boost::math::negative_binomial; // typedef provides default type is double.
#include <sstd/boost/math/distributions/binomial.hpp> // for binomial_distribution.
#include <sstd/boost/math/distributions/beta.hpp> // for beta_distribution.
#include <sstd/boost/math/distributions/gamma.hpp> // for gamma_distribution.
#include <sstd/boost/math/distributions/normal.hpp> // for normal_distribution.

#include <sstd/boost/multiprecision/cpp_dec_float.hpp> // for cpp_dec_float_100
/*`
