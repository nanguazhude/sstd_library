...
#include <sstd/boost/test/tools/floating_point_comparison.hpp> // For is_close_at)tolerance and is_small

//[brent_minimise_mp_include_0
#include <sstd/boost/multiprecision/cpp_dec_float.hpp> // For decimal boost::multiprecision::cpp_dec_float_50.
#include <sstd/boost/multiprecision/cpp_bin_float.hpp> // For binary boost::multiprecision::cpp_bin_float_50;
//] [/brent_minimise_mp_include_0]
