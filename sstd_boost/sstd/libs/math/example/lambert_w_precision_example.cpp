...
#include <sstd/boost/config.hpp> // for BOOST_PLATFORM, BOOST_COMPILER,  BOOST_STDLIB ...
#include <sstd/boost/version.hpp>   // for BOOST_MSVC versions.
#include <sstd/boost/cstdint.hpp>
#include <sstd/boost/exception/exception.hpp>  // boost::exception
...
#include <sstd/boost/math/special_functions/relative_difference.hpp> // for relative and epsilon difference.

// Built-in/fundamental GCC float128 or Intel Quad 128-bit type, if available.
#ifdef BOOST_HAS_FLOAT128
#include <sstd/boost/multiprecision/float128.hpp> // Not available for MSVC.
