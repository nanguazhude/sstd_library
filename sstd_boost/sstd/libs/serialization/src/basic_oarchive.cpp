...
#include <sstd/boost/config.hpp> // msvc 6.0 needs this for warning suppression
...
#include <sstd/boost/serialization/config.hpp>
#include <sstd/boost/serialization/state_saver.hpp>
#include <sstd/boost/serialization/throw_exception.hpp>
#include <sstd/boost/serialization/extended_type_info.hpp>

#include <sstd/boost/archive/detail/decl.hpp>
#include <sstd/boost/archive/basic_archive.hpp>
