...
#include <sstd/boost/polygon/isotropy.hpp>
#include <sstd/boost/polygon/point_concept.hpp>
#include <sstd/boost/polygon/segment_concept.hpp>
#include <sstd/boost/polygon/rectangle_concept.hpp>
