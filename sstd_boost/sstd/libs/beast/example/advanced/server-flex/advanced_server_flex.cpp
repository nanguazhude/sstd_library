...
#include <sstd/boost/beast/http.hpp>
#include <sstd/boost/beast/ssl.hpp>
#include <sstd/boost/beast/websocket.hpp>
...
namespace beast = boost::beast;                 // from <sstd/boost/beast.hpp>
namespace http = beast::http;                   // from <sstd/boost/beast/http.hpp>
namespace websocket = beast::websocket;         // from <sstd/boost/beast/websocket.hpp>
namespace net = boost::asio;                    // from <sstd/boost/asio.hpp>
namespace ssl = boost::asio::ssl;               // from <sstd/boost/asio/ssl.hpp>
using tcp = boost::asio::ip::tcp;               // from <sstd/boost/asio/ip/tcp.hpp>
