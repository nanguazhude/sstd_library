...
#include <sstd/boost/config.hpp>                      // for BOOST_MSVC
#include <sstd/boost/operators.hpp>                   // for the tested items
#include <sstd/boost/utility/detail/minstd_rand.hpp>  // for boost::detail::minstd_rand
