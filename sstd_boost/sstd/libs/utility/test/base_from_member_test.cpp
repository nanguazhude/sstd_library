...
#include <sstd/boost/config.hpp>       // for BOOST_NO_MEMBER_TEMPLATES
#include <sstd/boost/noncopyable.hpp>  // for boost::noncopyable

#include <sstd/boost/utility/base_from_member.hpp>  // for boost::base_from_member
