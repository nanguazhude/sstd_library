...
#include "sstd/boost/bind/apply.hpp" // Included just to test proper interaction with boost::apply<> as reported by Daniel Wallin
#include "sstd/boost/mpl/bool.hpp"
#include "sstd/boost/mpl/bool_fwd.hpp"  // For mpl::true_ and mpl::false_
