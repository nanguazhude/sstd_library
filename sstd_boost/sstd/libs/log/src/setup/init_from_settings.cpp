...
#include <sstd/boost/log/detail/setup_config.hpp>
#include <cstddef>
#include <ios>
#include <map>
#include <vector>
...
#include <sstd/boost/core/null_deleter.hpp>
...
#include <sstd/boost/spirit/home/qi/numeric/numeric_utils.hpp>
#include <sstd/boost/log/detail/code_conversion.hpp>
#include <sstd/boost/log/detail/singleton.hpp>
#include <sstd/boost/log/detail/default_attribute_names.hpp>
#include <sstd/boost/log/core.hpp>
#include <sstd/boost/log/sinks.hpp>
#include <sstd/boost/log/exceptions.hpp>
#include <sstd/boost/log/sinks/frontend_requirements.hpp>
#include <sstd/boost/log/expressions/filter.hpp>
#include <sstd/boost/log/expressions/formatter.hpp>
#include <sstd/boost/log/utility/string_literal.hpp>
#include <sstd/boost/log/utility/functional/nop.hpp>
#include <sstd/boost/log/utility/setup/from_settings.hpp>
#include <sstd/boost/log/utility/setup/filter_parser.hpp>
#include <sstd/boost/log/utility/setup/formatter_parser.hpp>
#if !defined(BOOST_LOG_NO_ASIO)
#include <sstd/boost/asio/ip/address.hpp>
#endif
#if !defined(BOOST_LOG_NO_THREADS)
#include <sstd/boost/log/detail/locks.hpp>
#include <sstd/boost/log/detail/light_rw_mutex.hpp>
#endif
