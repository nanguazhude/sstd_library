...
// define BOOST_FILESYSTEM_SOURCE so that <sstd/boost/filesystem/config.hpp> knows
...
#include <sstd/boost/smart_ptr/scoped_array.hpp>
...
#     define WINVER 0x501
#   endif
#   include <sstd/boost/winapi/dll.hpp> // get_proc_address, GetModuleHandleW
#   include <cwchar>
#   include <io.h>
#   include <windows.h>
#   include <winnt.h>
...
//  <sstd/boost/filesystem/path_traits.hpp>, thus avoiding header circularity.
