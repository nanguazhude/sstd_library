//
//  sstd/boost/signals2/mutex.hpp - header-only mutex
//
...
# include <sstd/boost/signals2/detail/lwm_nop.hpp>
#elif defined(BOOST_HAS_PTHREADS)
#  include <sstd/boost/signals2/detail/lwm_pthreads.hpp>
#elif defined(BOOST_HAS_WINTHREADS)
#  include <sstd/boost/signals2/detail/lwm_win32_cs.hpp>
#else
