...
#include <sstd/boost/interprocess/detail/utilities.hpp> //to_raw_pointer
#include <sstd/boost/utility/addressof.hpp> //boost::addressof
#include <sstd/boost/assert.hpp>   //BOOST_ASSERT
#include <sstd/boost/interprocess/exceptions.hpp> //bad_alloc
#include <sstd/boost/interprocess/sync/scoped_lock.hpp> //scoped_lock
#include <sstd/boost/interprocess/containers/allocation_type.hpp> //boost::interprocess::allocation_type
#include <sstd/boost/container/detail/multiallocation_chain.hpp>
#include <sstd/boost/interprocess/mem_algo/detail/mem_algo_common.hpp>
