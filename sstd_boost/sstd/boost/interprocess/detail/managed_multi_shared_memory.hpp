...
#include <sstd/boost/interprocess/detail/managed_memory_impl.hpp>
#include <sstd/boost/interprocess/creation_tags.hpp>
#include <sstd/boost/core/no_exceptions_support.hpp>
#include <sstd/boost/interprocess/detail/multi_segment_services.hpp>
#include <sstd/boost/interprocess/detail/utilities.hpp>
#include <sstd/boost/interprocess/shared_memory_object.hpp>
#include <sstd/boost/interprocess/containers/list.hpp>//list
#include <sstd/boost/interprocess/mapped_region.hpp> //mapped_region
#include <sstd/boost/interprocess/shared_memory_object.hpp>
#include <sstd/boost/interprocess/permissions.hpp>
#include <sstd/boost/interprocess/detail/managed_open_or_create_impl.hpp> //managed_open_or_create_impl
#include <sstd/boost/interprocess/containers/string.hpp>
#include <sstd/boost/interprocess/streams/vectorstream.hpp>
...
#include <sstd/boost/interprocess/mem_algo/rbtree_best_fit.hpp>
#include <sstd/boost/interprocess/sync/mutex_family.hpp>
