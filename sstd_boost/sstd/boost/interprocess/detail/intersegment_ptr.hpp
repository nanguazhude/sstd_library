...
#include <sstd/boost/interprocess/containers/flat_map.hpp>
#include <sstd/boost/interprocess/containers/vector.hpp>   //vector
#include <sstd/boost/interprocess/containers/set.hpp>      //set
// interprocess/detail
#include <sstd/boost/interprocess/detail/multi_segment_services.hpp>
#include <sstd/boost/interprocess/detail/utilities.hpp>
#include <sstd/boost/interprocess/detail/math_functions.hpp>
#include <sstd/boost/interprocess/detail/cast_tags.hpp>
#include <sstd/boost/interprocess/detail/mpl.hpp>
// other boost
#include <sstd/boost/core/no_exceptions_support.hpp>
#include <sstd/boost/static_assert.hpp>  //BOOST_STATIC_ASSERT
