...
#include <sstd/boost/interprocess/detail/win32_api.hpp>
#include <sstd/boost/interprocess/sync/spin/mutex.hpp>
#include <sstd/boost/interprocess/exceptions.hpp>
#include <sstd/boost/interprocess/sync/scoped_lock.hpp>
#include <sstd/boost/interprocess/sync/windows/winapi_semaphore_wrapper.hpp>
#include <sstd/boost/interprocess/sync/windows/winapi_mutex_wrapper.hpp>

//Shield against external warnings
#include <sstd/boost/interprocess/detail/config_external_begin.hpp>
   #include <sstd/boost/unordered/unordered_map.hpp>
#include <sstd/boost/interprocess/detail/config_external_end.hpp>
