...
#include <sstd/boost/interprocess/sync/interprocess_condition.hpp>
...
#include <sstd/boost/interprocess/sync/shm/named_creation_functor.hpp>
#include <sstd/boost/interprocess/sync/named_mutex.hpp>
#include <sstd/boost/interprocess/permissions.hpp>
   ...
   #include <sstd/boost/interprocess/sync/detail/condition_any_algorithm.hpp>
#else
