...
#include <sstd/boost/interprocess/containers/allocation_type.hpp>
...
#include <sstd/boost/interprocess/detail/min_max.hpp>
...
#include <sstd/boost/move/detail/type_traits.hpp> //make_unsigned, alignment_of
