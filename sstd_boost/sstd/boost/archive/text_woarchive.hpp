...
#include <sstd/boost/archive/detail/auto_link_warchive.hpp>
#include <sstd/boost/archive/basic_text_oprimitive.hpp>
#include <sstd/boost/archive/basic_text_oarchive.hpp>
