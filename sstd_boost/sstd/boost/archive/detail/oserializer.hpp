...
#include <sstd/boost/mpl/bool_fwd.hpp>
    ...
    #include <sstd/boost/serialization/extended_type_info_typeid.hpp>
#endif
#include <sstd/boost/serialization/throw_exception.hpp>
#include <sstd/boost/serialization/smart_cast.hpp>
#include <sstd/boost/serialization/assume_abstract.hpp>
#include <sstd/boost/serialization/static_warning.hpp>
...
#include <sstd/boost/serialization/void_cast.hpp>
#include <sstd/boost/serialization/collection_size_type.hpp>
#include <sstd/boost/serialization/array_wrapper.hpp>

#include <sstd/boost/serialization/singleton.hpp>

#include <sstd/boost/archive/archive_exception.hpp>
#include <sstd/boost/archive/detail/basic_oarchive.hpp>
#include <sstd/boost/archive/detail/basic_oserializer.hpp>
#include <sstd/boost/archive/detail/basic_pointer_oserializer.hpp>
#include <sstd/boost/archive/detail/archive_serializer_map.hpp>
#include <sstd/boost/archive/detail/check.hpp>
