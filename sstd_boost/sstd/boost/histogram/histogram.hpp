...
#include <sstd/boost/histogram/detail/axes.hpp>
#include <sstd/boost/histogram/detail/common_type.hpp>
#include <sstd/boost/histogram/detail/linearize.hpp>
#include <sstd/boost/histogram/detail/meta.hpp>
...
/** Central class of the histogram library.
  ...
  Use the [indexed](sstd/boost/histogram/indexed.html) range generator to iterate over filled
...
public:
  ...
  /** Fill histogram with values, an optional weight, and/or a sample.
   ...
   with the [weight](sstd/boost/histogram/weight.html) helper function. Compilation fails if
   ...
   [sample](sstd/boost/histogram/sample.html) helper function can pass one or more arguments to
