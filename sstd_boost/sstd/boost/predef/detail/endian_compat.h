...
#pragma message("The use of BOOST_*_ENDIAN and BOOST_BYTE_ORDER is deprecated. Please include <sstd/boost/predef/other/endian.h> and use BOOST_ENDIAN_*_BYTE instead")
