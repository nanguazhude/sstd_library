...
#include <sstd/boost/config.hpp> // Member template friends, put size_t in std.
#include <cstddef>          // size_t
#include <sstd/boost/compressed_pair.hpp>
#include <sstd/boost/ptr_container/detail/default_deleter.hpp>
#include <sstd/boost/ptr_container/detail/is_convertible.hpp>
#include <sstd/boost/ptr_container/detail/move.hpp>
