...
#include <sstd/boost/ptr_container/detail/associative_ptr_container.hpp>
#include <sstd/boost/ptr_container/detail/meta_functions.hpp>
#include <sstd/boost/ptr_container/detail/void_ptr_iterator.hpp>
