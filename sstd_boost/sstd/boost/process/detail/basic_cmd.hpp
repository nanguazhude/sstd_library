...
#include <sstd/boost/process/detail/traits/cmd_or_exe.hpp>
#include <sstd/boost/process/detail/traits/wchar_t.hpp>

#if defined( BOOST_WINDOWS_API )
#include <sstd/boost/process/detail/windows/basic_cmd.hpp>
#include <sstd/boost/process/detail/windows/cmd.hpp>
#elif defined( BOOST_POSIX_API )
#include <sstd/boost/process/detail/posix/basic_cmd.hpp>
#include <sstd/boost/process/detail/posix/cmd.hpp>
#endif
