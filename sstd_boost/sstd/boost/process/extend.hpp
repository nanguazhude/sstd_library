...
#include <sstd/boost/process/detail/handler.hpp>

#if defined(BOOST_WINDOWS_API)
#include <sstd/boost/process/detail/windows/executor.hpp>
#include <sstd/boost/process/detail/windows/async_handler.hpp>
#include <sstd/boost/process/detail/windows/asio_fwd.hpp>
#else
#include <sstd/boost/process/detail/posix/executor.hpp>
#include <sstd/boost/process/detail/posix/async_handler.hpp>
