...
#include <functional>
#include <utility>
#include <sstd/boost/process/detail/config.hpp>
#include <sstd/boost/process/pipe.hpp>

#include <future>

#if defined(BOOST_POSIX_API)
#include <sstd/boost/process/detail/posix/asio_fwd.hpp>
#include <sstd/boost/process/detail/posix/close_in.hpp>
#include <sstd/boost/process/detail/posix/close_out.hpp>
#include <sstd/boost/process/detail/posix/null_in.hpp>
#include <sstd/boost/process/detail/posix/null_out.hpp>
#include <sstd/boost/process/detail/posix/file_in.hpp>
#include <sstd/boost/process/detail/posix/file_out.hpp>
#include <sstd/boost/process/detail/posix/pipe_in.hpp>
#include <sstd/boost/process/detail/posix/pipe_out.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <sstd/boost/process/detail/windows/asio_fwd.hpp>
#include <sstd/boost/process/detail/windows/close_in.hpp>
#include <sstd/boost/process/detail/windows/close_out.hpp>
#include <sstd/boost/process/detail/windows/null_in.hpp>
#include <sstd/boost/process/detail/windows/null_out.hpp>
#include <sstd/boost/process/detail/windows/file_in.hpp>
#include <sstd/boost/process/detail/windows/file_out.hpp>
#include <sstd/boost/process/detail/windows/pipe_in.hpp>
