...
#include <sstd/boost/wave/util/file_position.hpp>
#include <sstd/boost/wave/cpplexer/validate_universal_char.hpp>
#include <sstd/boost/wave/cpplexer/cpplexer_exceptions.hpp>
#include <sstd/boost/wave/cpplexer/token_cache.hpp>
#include <sstd/boost/wave/cpplexer/convert_trigraphs.hpp>

#include <sstd/boost/wave/cpplexer/cpp_lex_interface.hpp>
#include <sstd/boost/wave/cpplexer/re2clex/scanner.hpp>
#include <sstd/boost/wave/cpplexer/re2clex/cpp_re.hpp>
#if BOOST_WAVE_SUPPORT_PRAGMA_ONCE != 0
#include <sstd/boost/wave/cpplexer/detect_include_guards.hpp>
#endif

#include <sstd/boost/wave/cpplexer/cpp_lex_interface_generator.hpp>
