...
#include <sstd/boost/serialization/shared_ptr.hpp>
#endif

#include <sstd/boost/filesystem/path.hpp>
#include <sstd/boost/lexical_cast.hpp>

#include <sstd/boost/wave/util/time_conversion_helper.hpp>
#include <sstd/boost/wave/util/unput_queue_iterator.hpp>
#include <sstd/boost/wave/util/macro_helpers.hpp>
#include <sstd/boost/wave/util/macro_definition.hpp>
#include <sstd/boost/wave/util/symbol_table.hpp>
#include <sstd/boost/wave/util/cpp_macromap_utils.hpp>
#include <sstd/boost/wave/util/cpp_macromap_predef.hpp>
#include <sstd/boost/wave/util/filesystem_compatibility.hpp>
#include <sstd/boost/wave/grammars/cpp_defined_grammar_gen.hpp>

#include <sstd/boost/wave/wave_version.hpp>
