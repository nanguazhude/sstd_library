...
#include <sstd/boost/spirit/include/classic_multi_pass.hpp>
#include <sstd/boost/spirit/include/classic_parse_tree_utils.hpp>

#include <sstd/boost/wave/wave_config.hpp>
#include <sstd/boost/pool/pool_alloc.hpp>

#include <sstd/boost/wave/util/insert_whitespace_detection.hpp>
#include <sstd/boost/wave/util/macro_helpers.hpp>
#include <sstd/boost/wave/util/cpp_macromap_utils.hpp>
#include <sstd/boost/wave/util/interpret_pragma.hpp>
#include <sstd/boost/wave/util/transform_iterator.hpp>
#include <sstd/boost/wave/util/functor_input.hpp>
#include <sstd/boost/wave/util/filesystem_compatibility.hpp>

#include <sstd/boost/wave/grammars/cpp_grammar_gen.hpp>
#include <sstd/boost/wave/grammars/cpp_expression_grammar_gen.hpp>
#if BOOST_WAVE_ENABLE_COMMANDLINE_MACROS != 0
#include <sstd/boost/wave/grammars/cpp_predef_macros_gen.hpp>
#endif

#include <sstd/boost/wave/whitespace_handling.hpp>
#include <sstd/boost/wave/cpp_iteration_context.hpp>
#include <sstd/boost/wave/cpp_exceptions.hpp>
#include <sstd/boost/wave/language_support.hpp>
