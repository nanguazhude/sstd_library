...
#       define  BOOST_PP_FILENAME_1 <sstd/boost/functional/forward_adapter.hpp>
...
#     define  BOOST_PP_FILENAME_2 <sstd/boost/functional/forward_adapter.hpp>
#     define  BOOST_PP_ITERATION_LIMITS (0,limit2)
#     include BOOST_PP_ITERATE()
#   elif BOOST_PP_ITERATION_DEPTH() == 2 && limit3
#     define  BOOST_PP_FILENAME_3 <sstd/boost/functional/forward_adapter.hpp>
