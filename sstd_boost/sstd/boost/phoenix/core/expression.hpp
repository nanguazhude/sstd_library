...
#include <sstd/boost/phoenix/core/as_actor.hpp>
#include <sstd/boost/phoenix/core/detail/expression.hpp>
...
namespace boost { namespace phoenix
{
    ...
    #include <sstd/boost/phoenix/core/detail/cpp03/expression.hpp>
#else
