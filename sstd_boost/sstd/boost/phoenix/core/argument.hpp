...
#include <sstd/boost/phoenix/core/terminal.hpp>
...
#include <sstd/boost/phoenix/core/detail/cpp03/preprocessed/argument.hpp>

#else

#if !defined(BOOST_PHOENIX_CREATE_PREPROCESSED_FILES)
#include <sstd/boost/phoenix/core/detail/argument.hpp>
#else
