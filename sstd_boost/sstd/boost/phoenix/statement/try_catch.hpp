...
#include <sstd/boost/phoenix/config.hpp>
...
#include <sstd/boost/phoenix/scope/scoped_environment.hpp>
#include <sstd/boost/proto/functional/fusion/pop_front.hpp>
...
namespace boost { namespace phoenix
{
    ...
    namespace expression
    {
        ...
        #include <sstd/boost/phoenix/statement/detail/try_catch_expression.hpp>
    ...
    struct try_catch_eval
    {
        ...
        #include <sstd/boost/phoenix/statement/detail/try_catch_eval.hpp>
    };
    ...
    namespace detail
    {
        ...
        #include <sstd/boost/phoenix/statement/detail/catch_push_back.hpp>
    }
