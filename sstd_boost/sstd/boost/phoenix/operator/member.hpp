...
#include <sstd/boost/proto/operators.hpp>
#include <sstd/boost/phoenix/support/iterate.hpp>

#ifdef BOOST_PHOENIX_NO_VARIADIC_EXPRESSION
#   include <sstd/boost/phoenix/operator/detail/cpp03/mem_fun_ptr_expr.hpp>
#else
...
#include <sstd/boost/phoenix/operator/detail/define_operator.hpp>

namespace boost { namespace phoenix
{
#if defined(BOOST_PHOENIX_NO_VARIADIC_OPERATOR)
    #include <sstd/boost/phoenix/operator/detail/cpp03/mem_fun_ptr_gen.hpp>
#else
    // TODO
#endif
...
#if defined(BOOST_PHOENIX_NO_VARIADIC_OPERATOR)
        #include <sstd/boost/phoenix/operator/detail/cpp03/mem_fun_ptr_eval_result_of.hpp>
#else
    // TODO
#endif
    }
...
#if defined(BOOST_PHOENIX_NO_VARIADIC_OPERATOR)
        #include <sstd/boost/phoenix/operator/detail/cpp03/mem_fun_ptr_eval.hpp>
#else
    // TODO
#endif
    };
