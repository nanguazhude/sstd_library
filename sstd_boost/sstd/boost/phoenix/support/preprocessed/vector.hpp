...
#include <sstd/boost/phoenix/support/preprocessed/vector_10.hpp>
#elif BOOST_PHOENIX_LIMIT <= 20
#include <sstd/boost/phoenix/support/preprocessed/vector_20.hpp>
#elif BOOST_PHOENIX_LIMIT <= 30
#include <sstd/boost/phoenix/support/preprocessed/vector_30.hpp>
#elif BOOST_PHOENIX_LIMIT <= 40
#include <sstd/boost/phoenix/support/preprocessed/vector_40.hpp>
#elif BOOST_PHOENIX_LIMIT <= 50
#include <sstd/boost/phoenix/support/preprocessed/vector_50.hpp>
#else
