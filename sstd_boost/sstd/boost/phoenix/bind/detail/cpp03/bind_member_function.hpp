...
#include <sstd/boost/phoenix/core/detail/function_eval.hpp>
#include <sstd/boost/phoenix/bind/detail/cpp03/member_function_ptr.hpp>
...
namespace boost { namespace phoenix
{
    ...
    #include <sstd/boost/phoenix/bind/detail/cpp03/preprocessed/bind_member_function.hpp>
#else
...
#define BOOST_PHOENIX_ITERATION_PARAMS                                          \
    (3, (1, BOOST_PP_DEC(BOOST_PHOENIX_ACTOR_LIMIT),                            \
            <sstd/boost/phoenix/bind/detail/cpp03/bind_member_function.hpp>))
