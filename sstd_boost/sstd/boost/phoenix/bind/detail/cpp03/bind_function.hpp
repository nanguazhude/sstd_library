...
#include <sstd/boost/phoenix/bind/detail/cpp03/function_ptr.hpp>
...
namespace boost { namespace phoenix {
    ...
    #include <sstd/boost/phoenix/bind/detail/cpp03/preprocessed/bind_function.hpp>
#else
...
#define BOOST_PHOENIX_ITERATION_PARAMS                                          \
    (3, (2, BOOST_PP_DEC(BOOST_PHOENIX_ACTOR_LIMIT),                            \
            <sstd/boost/phoenix/bind/detail/cpp03/bind_function.hpp>))
