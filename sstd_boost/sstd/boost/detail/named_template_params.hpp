...
#include <sstd/boost/type_traits/composite_traits.hpp> // for is_reference
#if defined(__BORLANDC__)
#include <sstd/boost/type_traits/ice.hpp>
#endif
...
namespace boost {
  namespace detail {
   ...
   template <class Gen> struct default_generator {
    ...
    // sstd/boost/iterator_adaptors.hpp for an example usage.  Also,
