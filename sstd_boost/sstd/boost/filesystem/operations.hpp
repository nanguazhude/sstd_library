...
#include <sstd/boost/detail/bitmask.hpp>
...
#include <sstd/boost/smart_ptr/intrusive_ref_counter.hpp>
...
#include <sstd/boost/config/abi_prefix.hpp> // must be the last #include
