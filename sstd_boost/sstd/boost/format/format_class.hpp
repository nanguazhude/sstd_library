...
#include <sstd/boost/optional.hpp> // to store locale when needed

#include <sstd/boost/format/format_fwd.hpp>
#include <sstd/boost/format/internals_fwd.hpp>
#include <sstd/boost/format/internals.hpp>
#include <sstd/boost/format/alt_sstream.hpp>
