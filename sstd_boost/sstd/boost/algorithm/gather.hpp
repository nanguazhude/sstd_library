...
#include <sstd/boost/bind.hpp>           // for boost::bind
#include <sstd/boost/range/begin.hpp>    // for boost::begin(range)
#include <sstd/boost/range/end.hpp>      // for boost::end(range)
