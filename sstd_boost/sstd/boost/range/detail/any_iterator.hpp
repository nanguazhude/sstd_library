...
#include <sstd/boost/range/detail/any_iterator_buffer.hpp>
#include <sstd/boost/range/detail/any_iterator_interface.hpp>
#include <sstd/boost/range/detail/any_iterator_wrapper.hpp>
