...
#include <sstd/boost/optional/bad_optional_access.hpp>
...
#include <sstd/boost/utility/compare_pointees.hpp>
#include <sstd/boost/utility/result_of.hpp>

#include <sstd/boost/optional/optional_fwd.hpp>
#include <sstd/boost/optional/detail/optional_config.hpp>
#include <sstd/boost/optional/detail/optional_factory_support.hpp>
#include <sstd/boost/optional/detail/optional_aligned_storage.hpp>
...
#include <sstd/boost/optional/detail/old_optional_implementation.hpp>
#else
namespace boost {
...
#include <sstd/boost/optional/detail/optional_trivially_copyable_base.hpp>
...
# include <sstd/boost/optional/detail/optional_reference_spec.hpp>
#endif
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output boost::optional, include header <sstd/boost/optional/optional_io.hpp>");
  return os;
}

} // namespace boost

#include <sstd/boost/optional/detail/optional_relops.hpp>
