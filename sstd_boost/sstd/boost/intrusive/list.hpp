...
#include <sstd/boost/intrusive/list_hook.hpp>
#include <sstd/boost/intrusive/circular_list_algorithms.hpp>
...
#include <sstd/boost/intrusive/detail/list_iterator.hpp>
