...
#include <sstd/boost/parameter/parameters.hpp> // for is_named_argument
...
#include <sstd/boost/log/detail/sink_init_helpers.hpp>
...
#include <sstd/boost/log/keywords/scan_method.hpp>
