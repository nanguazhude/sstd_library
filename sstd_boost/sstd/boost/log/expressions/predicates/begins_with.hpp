...
#include <sstd/boost/log/detail/embedded_string_type.hpp>
#include <sstd/boost/log/detail/unary_function_terminal.hpp>
#include <sstd/boost/log/detail/attribute_predicate.hpp>
