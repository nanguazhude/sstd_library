...
#include <sstd/boost/phoenix/core/actor.hpp>
#include <sstd/boost/phoenix/core/terminal_fwd.hpp>
#include <sstd/boost/phoenix/core/is_nullary.hpp>
#include <sstd/boost/phoenix/core/environment.hpp>
...
#include <sstd/boost/log/attributes/fallback_policy.hpp>
#include <sstd/boost/log/attributes/named_scope.hpp>
#include <sstd/boost/log/attributes/value_visitation.hpp>
#include <sstd/boost/log/detail/light_function.hpp>
#include <sstd/boost/log/detail/parameter_tools.hpp>
#include <sstd/boost/log/detail/custom_terminal_spec.hpp>
#include <sstd/boost/log/detail/deduce_char_type.hpp>
#include <sstd/boost/log/detail/attr_output_terminal.hpp>
#include <sstd/boost/log/expressions/attr_fwd.hpp>
#include <sstd/boost/log/expressions/keyword_fwd.hpp>
#include <sstd/boost/log/utility/formatting_ostream.hpp>
#include <sstd/boost/log/utility/string_literal_fwd.hpp>
#include <sstd/boost/log/utility/functional/bind.hpp>
#include <sstd/boost/log/keywords/format.hpp>
#include <sstd/boost/log/keywords/delimiter.hpp>
#include <sstd/boost/log/keywords/depth.hpp>
#include <sstd/boost/log/keywords/iteration.hpp>
#include <sstd/boost/log/keywords/empty_marker.hpp>
#include <sstd/boost/log/keywords/incomplete_marker.hpp>
...
#include <sstd/boost/log/detail/generate_overloads.hpp>
...
#   define BOOST_PP_FILENAME_1 <sstd/boost/log/detail/named_scope_fmt_pp.hpp>
