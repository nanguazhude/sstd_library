...
#include <sstd/boost/date_time/date_defs.hpp>
#include <sstd/boost/date_time/special_defs.hpp>
#include <sstd/boost/date_time/gregorian/greg_day.hpp>
#include <sstd/boost/date_time/posix_time/posix_time_types.hpp>
#include <sstd/boost/filesystem/path.hpp>
#include <sstd/boost/log/keywords/max_size.hpp>
#include <sstd/boost/log/keywords/max_files.hpp>
#include <sstd/boost/log/keywords/min_free_space.hpp>
#include <sstd/boost/log/keywords/target.hpp>
#include <sstd/boost/log/keywords/target_file_name.hpp>
#include <sstd/boost/log/keywords/file_name.hpp>
#include <sstd/boost/log/keywords/open_mode.hpp>
#include <sstd/boost/log/keywords/auto_flush.hpp>
#include <sstd/boost/log/keywords/rotation_size.hpp>
#include <sstd/boost/log/keywords/time_based_rotation.hpp>
#include <sstd/boost/log/keywords/enable_final_rotation.hpp>
...
#include <sstd/boost/log/sinks/basic_sink_backend.hpp>
#include <sstd/boost/log/sinks/frontend_requirements.hpp>
