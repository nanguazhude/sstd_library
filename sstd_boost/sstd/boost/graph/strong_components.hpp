...
#include <queue>
#include <vector>
#include <sstd/boost/graph/transpose_graph.hpp>
#include <sstd/boost/pending/indirect_cmp.hpp>
#include <sstd/boost/graph/connected_components.hpp> // for components_recorder
...
#  include <sstd/boost/graph/distributed/strong_components.hpp>
#endif
