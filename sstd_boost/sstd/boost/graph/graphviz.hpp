...
#include <sstd/boost/graph/dll_import_export.hpp>
...
#  endif
#  include <sstd/boost/graph/detail/read_graphviz_spirit.hpp>
#else // New default parser
#  include <sstd/boost/graph/detail/read_graphviz_new.hpp>
