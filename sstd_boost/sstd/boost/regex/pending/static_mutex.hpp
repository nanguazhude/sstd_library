...
#include <sstd/boost/regex/config.hpp> // dll import/export options.
...
//
#define BOOST_REGEX_H1 <sstd/boost/thread/once.hpp>
#define BOOST_REGEX_H2 <sstd/boost/thread/recursive_mutex.hpp>
#define BOOST_REGEX_H3 <sstd/boost/thread/lock_types.hpp>
