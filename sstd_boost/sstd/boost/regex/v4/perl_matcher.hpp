...
#include <sstd/boost/regex/v4/iterator_category.hpp>
...
//
#ifdef BOOST_REGEX_RECURSIVE
#include <sstd/boost/regex/v4/perl_matcher_recursive.hpp>
#else
#include <sstd/boost/regex/v4/perl_matcher_non_recursive.hpp>
#endif
