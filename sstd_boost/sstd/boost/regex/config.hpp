...
#  include <sstd/boost/regex/config/borland.hpp>
#endif
...
#     define BOOST_REGEX_USER_CONFIG <sstd/boost/regex/user.hpp>
#  endif
...
#  include <sstd/boost/predef.h>
   ...
   /*
    * C build,
    * don't include <sstd/boost/config.hpp> because that may
...
#ifdef __cplusplus
#  include <sstd/boost/regex/config/cwchar.hpp>
#endif
