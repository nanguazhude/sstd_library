...
#include <sstd/boost/accumulators/framework/depends_on.hpp> // for feature_of
#include <sstd/boost/accumulators/framework/parameters/accumulator.hpp> // for accumulator
