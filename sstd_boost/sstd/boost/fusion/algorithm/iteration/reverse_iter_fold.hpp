...
#include <sstd/boost/fusion/algorithm/iteration/reverse_iter_fold_fwd.hpp>
...
#include <sstd/boost/fusion/algorithm/iteration/detail/preprocessed/reverse_iter_fold.hpp>
#else
