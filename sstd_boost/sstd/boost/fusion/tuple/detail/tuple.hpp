...
#include <sstd/boost/fusion/tuple/detail/tuple_fwd.hpp>
...
#include <sstd/boost/fusion/sequence/io.hpp>
...
#include <sstd/boost/fusion/tuple/detail/preprocessed/tuple.hpp>
#else
...
namespace boost { namespace fusion
{
    ...
    struct tuple : vector<BOOST_PP_ENUM_PARAMS(FUSION_MAX_VECTOR_SIZE, T)>
    {
        ...
        #include <sstd/boost/fusion/tuple/detail/tuple_expand.hpp>
