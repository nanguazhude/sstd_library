...
#include <sstd/boost/fusion/container/generation/detail/preprocessed/vector_tie.hpp>
#else
...
#define BOOST_PP_FILENAME_1 <sstd/boost/fusion/container/generation/detail/pp_vector_tie.hpp>
