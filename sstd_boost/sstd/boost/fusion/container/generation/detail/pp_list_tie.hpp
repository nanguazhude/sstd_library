...
#include <sstd/boost/fusion/container/generation/detail/preprocessed/list_tie.hpp>
#else
...
#define BOOST_PP_FILENAME_1 <sstd/boost/fusion/container/generation/detail/pp_list_tie.hpp>
