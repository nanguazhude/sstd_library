...
#include <sstd/boost/fusion/container/list/detail/cpp03/list_fwd.hpp>
#include <sstd/boost/fusion/container/list/detail/cpp03/list_to_cons.hpp>
#include <sstd/boost/fusion/support/is_sequence.hpp>
#include <sstd/boost/core/enable_if.hpp>

#if !defined(BOOST_FUSION_DONT_USE_PREPROCESSED_FILES)
#include <sstd/boost/fusion/container/list/detail/cpp03/preprocessed/list.hpp>
#else
...
namespace boost { namespace fusion
{
    ...
    public:
        ...
        #include <sstd/boost/fusion/container/list/detail/cpp03/list_forward_ctor.hpp>
