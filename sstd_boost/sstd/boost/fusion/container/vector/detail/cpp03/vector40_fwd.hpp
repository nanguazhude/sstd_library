...
#include <sstd/boost/fusion/container/vector/detail/cpp03/preprocessed/vector40_fwd.hpp>
#else
...
namespace boost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 <sstd/boost/fusion/container/vector/detail/cpp03/vector40_fwd.hpp>
