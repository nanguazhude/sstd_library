...
#include <sstd/boost/fusion/container/vector/detail/cpp03/preprocessed/vector20_fwd.hpp>
#else
...
namespace boost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 <sstd/boost/fusion/container/vector/detail/cpp03/vector20_fwd.hpp>
