...
#include <sstd/boost/fusion/container/vector/detail/cpp03/preprocessed/vector50_fwd.hpp>
#else
...
namespace boost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 <sstd/boost/fusion/container/vector/detail/cpp03/vector50_fwd.hpp>
