...
#include <sstd/boost/fusion/container/set/detail/begin_impl.hpp>
#include <sstd/boost/fusion/container/set/detail/end_impl.hpp>
#include <sstd/boost/fusion/container/set/detail/value_of_impl.hpp>
#include <sstd/boost/fusion/container/set/detail/deref_data_impl.hpp>
#include <sstd/boost/fusion/container/set/detail/deref_impl.hpp>
#include <sstd/boost/fusion/container/set/detail/key_of_impl.hpp>
#include <sstd/boost/fusion/container/set/detail/value_of_data_impl.hpp>
...
#include <sstd/boost/fusion/container/set/detail/cpp03/preprocessed/set.hpp>
#else
...
namespace boost { namespace fusion
{
    ...
    struct set : sequence_base<set<BOOST_PP_ENUM_PARAMS(FUSION_MAX_SET_SIZE, T)> >
    {
        ...
        #include <sstd/boost/fusion/container/set/detail/cpp03/set_forward_ctor.hpp>
