...
#include <sstd/boost/function_types/is_member_pointer.hpp>
...
#include <sstd/boost/fusion/functional/invocation/limits.hpp>
#include <sstd/boost/fusion/functional/invocation/detail/that_ptr.hpp>
...
namespace boost { namespace fusion
{
    namespace detail
    {
        ...
        #define  BOOST_PP_FILENAME_1 <sstd/boost/fusion/functional/invocation/invoke.hpp>
