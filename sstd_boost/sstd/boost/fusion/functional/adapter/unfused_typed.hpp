...
#include <sstd/boost/fusion/functional/adapter/limits.hpp>
#include <sstd/boost/fusion/functional/adapter/detail/access.hpp>
...
namespace boost { namespace fusion
{
    ...
    #define  BOOST_PP_FILENAME_1 <sstd/boost/fusion/functional/adapter/unfused_typed.hpp>
