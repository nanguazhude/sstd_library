...
#include <sstd/boost/fusion/functional/generation/make_fused.hpp>
#include <sstd/boost/fusion/functional/generation/make_fused_procedure.hpp>
#include <sstd/boost/fusion/functional/generation/make_fused_function_object.hpp>
