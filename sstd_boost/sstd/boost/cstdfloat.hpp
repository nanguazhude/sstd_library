...
// <sstd/boost/cstdfloat.hpp> implements floating-point typedefs having
...
// See: http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3626.pdf
  ...
  #include <sstd/boost/math/cstdfloat/cstdfloat_types.hpp>
  ...
  // Support a specialization of std::numeric_limits<> for the wrapped quadmath library (if available).
    ...
    #include <sstd/boost/math/cstdfloat/cstdfloat_limits.hpp>
  #endif

  // Support <cmath> functions for the wrapped quadmath library (if available).
  #if !defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_CMATH)
    #include <sstd/boost/math/cstdfloat/cstdfloat_cmath.hpp>
  #endif
  ...
  // Support I/O stream operations for the wrapped quadmath library (if available).
    ...
    #if defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_CMATH)
    #error You can not use <sstd/boost/math/cstdfloat/cstdfloat_iostream.hpp> with BOOST_CSTDFLOAT_NO_LIBQUADMATH_CMATH defined.
    #endif
    #include <sstd/boost/math/cstdfloat/cstdfloat_iostream.hpp>
  #endif
  ...
  // Support a specialization of std::complex<> for the wrapped quadmath library (if available).
    ...
    #if defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_LIMITS)
    #error You can not use <sstd/boost/math/cstdfloat/cstdfloat_complex.hpp> with BOOST_CSTDFLOAT_NO_LIBQUADMATH_LIMITS defined.
    #endif
    #if defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_CMATH)
    #error You can not use <sstd/boost/math/cstdfloat/cstdfloat_complex.hpp> with BOOST_CSTDFLOAT_NO_LIBQUADMATH_CMATH defined.
    #endif
    #if defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_IOSTREAM)
    #error You can not use <sstd/boost/math/cstdfloat/cstdfloat_complex.hpp> with BOOST_CSTDFLOAT_NO_LIBQUADMATH_IOSTREAM defined.
    #endif
    #include <sstd/boost/math/cstdfloat/cstdfloat_complex.hpp>
  #endif
