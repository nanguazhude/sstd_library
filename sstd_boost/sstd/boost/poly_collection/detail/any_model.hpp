...
#include <sstd/boost/mpl/map/map10.hpp>
#include <sstd/boost/mpl/pair.hpp>
#include <sstd/boost/mpl/vector/vector10.hpp>
#include <sstd/boost/poly_collection/detail/any_iterator.hpp>
#include <sstd/boost/poly_collection/detail/is_acceptable.hpp>
#include <sstd/boost/poly_collection/detail/segment_backend.hpp>
#include <sstd/boost/poly_collection/detail/split_segment.hpp>
...
#include <sstd/boost/type_erasure/is_subconcept.hpp>
#include <sstd/boost/type_erasure/relaxed.hpp>
#include <sstd/boost/type_erasure/static_binding.hpp>
#include <sstd/boost/type_erasure/typeid_of.hpp>
#include <memory>
#include <type_traits>
#include <typeinfo>
#include <utility>
