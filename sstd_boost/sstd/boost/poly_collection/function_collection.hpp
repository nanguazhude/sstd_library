...
#include <sstd/boost/poly_collection/function_collection_fwd.hpp>
#include <sstd/boost/poly_collection/detail/function_model.hpp>
#include <sstd/boost/poly_collection/detail/poly_collection.hpp>
#include <utility>
