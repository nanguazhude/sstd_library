...
#include <sstd/boost/units/static_constant.hpp>

#include <sstd/boost/units/systems/detail/constants.hpp>
...
#include <sstd/boost/units/systems/si/codata/typedefs.hpp>
