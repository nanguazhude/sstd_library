...
#include <sstd/boost/container/allocator_traits.hpp>             //allocator_traits
#include <sstd/boost/container/throw_exception.hpp>
#include <sstd/boost/container/detail/multiallocation_chain.hpp> //multiallocation_chain
#include <sstd/boost/container/detail/version_type.hpp>          //version_type
#include <sstd/boost/container/detail/allocation_type.hpp>       //allocation_type
#include <sstd/boost/container/detail/mpl.hpp>                   //integral_constant
#include <sstd/boost/intrusive/pointer_traits.hpp>               //pointer_traits
#include <sstd/boost/core/no_exceptions_support.hpp>             //BOOST_TRY
