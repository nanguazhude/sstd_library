...
#       include <sstd/boost/stacktrace/detail/collect_noop.ipp>
#   else
#       if defined(BOOST_WINDOWS)
#           include <sstd/boost/stacktrace/detail/safe_dump_win.ipp>
#       else
#           include <sstd/boost/stacktrace/detail/safe_dump_posix.ipp>
#       endif
#       if defined(BOOST_WINDOWS) && !defined(BOOST_WINAPI_IS_MINGW) // MinGW does not provide RtlCaptureStackBackTrace. MinGW-w64 does.
#           include <sstd/boost/stacktrace/detail/collect_msvc.ipp>
#       else
#           include <sstd/boost/stacktrace/detail/collect_unwind.ipp>
#       endif
#   endif
#endif
