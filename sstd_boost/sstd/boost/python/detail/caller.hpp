...
#  include <sstd/boost/python/detail/invoke.hpp>
...
#  include <sstd/boost/python/arg_from_python.hpp>
#  include <sstd/boost/python/converter/context_result_converter.hpp>
...
#  include <sstd/boost/preprocessor/if.hpp>
...
#  include <sstd/boost/compressed_pair.hpp>
...
#  define BOOST_PP_ITERATION_PARAMS_1                                            \
        (3, (0, BOOST_PYTHON_MAX_ARITY + 1, <sstd/boost/python/detail/caller.hpp>))
