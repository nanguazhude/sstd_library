...
# include <sstd/boost/python/converter/registered.hpp>
# include <sstd/boost/python/converter/registered_pointee.hpp>
# include <sstd/boost/python/converter/arg_to_python_base.hpp>
# include <sstd/boost/python/converter/shared_ptr_to_python.hpp>
// Bring in specializations
# include <sstd/boost/python/converter/builtin_converters.hpp>

# include <sstd/boost/python/object/function_handle.hpp>

# include <sstd/boost/python/base_type_traits.hpp>

# include <sstd/boost/python/detail/indirect_traits.hpp>
# include <sstd/boost/python/detail/convertible.hpp>
# include <sstd/boost/python/detail/string_literal.hpp>
# include <sstd/boost/python/detail/value_is_shared_ptr.hpp>
