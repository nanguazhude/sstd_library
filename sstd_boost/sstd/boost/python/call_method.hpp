...
#  include <sstd/boost/python/converter/return_from_python.hpp>
...
# define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PYTHON_MAX_ARITY, <sstd/boost/python/call_method.hpp>))
