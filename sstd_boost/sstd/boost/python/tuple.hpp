...
#include <sstd/boost/python/converter/pytype_object_mgr_traits.hpp>
...
# define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_PYTHON_MAX_ARITY, <sstd/boost/python/detail/make_tuple.hpp>))
