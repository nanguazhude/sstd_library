...
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <sstd/boost/python/object/pointer_holder.hpp>, 1))
...
struct pointer_holder_back_reference : instance_holder
{
 ...
 public:
    ...
    // Forward construction to the held object
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <sstd/boost/python/object/pointer_holder.hpp>, 2))
#  include BOOST_PP_ITERATE()
