...
#  include <sstd/boost/python/object/value_holder_fwd.hpp>

#  include <sstd/boost/python/instance_holder.hpp>
#  include <sstd/boost/python/type_id.hpp>
#  include <sstd/boost/python/wrapper.hpp>
...
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <sstd/boost/python/object/value_holder.hpp>, 1))
...
struct value_holder_back_reference : instance_holder
{
    ...
    // Forward construction to the held object
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <sstd/boost/python/object/value_holder.hpp>, 2))
#  include BOOST_PP_ITERATE()
