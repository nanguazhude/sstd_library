...
# include <sstd/boost/python/handle_fwd.hpp>
# include <sstd/boost/python/errors.hpp>
# include <sstd/boost/python/refcount.hpp>
# include <sstd/boost/python/detail/preprocessor.hpp>
# include <sstd/boost/python/tag.hpp>
# include <sstd/boost/python/def_visitor.hpp>

# include <sstd/boost/python/detail/raw_pyobject.hpp>
# include <sstd/boost/python/detail/dependent.hpp>

# include <sstd/boost/python/object/forward.hpp>
...
# include <sstd/boost/python/detail/is_xxx.hpp>
# include <sstd/boost/python/detail/string_literal.hpp>
# include <sstd/boost/python/detail/def_helper_fwd.hpp>
...
# define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_PYTHON_MAX_ARITY, <sstd/boost/python/object_call.hpp>))
