...
#include <sstd/boost/dll/detail/aggressive_ptr_cast.hpp>
#if BOOST_OS_WINDOWS
#   include <sstd/boost/winapi/dll.hpp>
#   include <sstd/boost/dll/detail/windows/path_from_handle.hpp>
#else
#   include <dlfcn.h>
#   include <sstd/boost/dll/detail/posix/program_location_impl.hpp>
#endif
...
/// \file sstd/boost/dll/runtime_symbol_info.hpp
