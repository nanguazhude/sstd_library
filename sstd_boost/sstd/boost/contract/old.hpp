...
#include <sstd/boost/contract/core/virtual.hpp>
    ...
    #include <sstd/boost/contract/detail/checking.hpp>
#endif
#include <sstd/boost/contract/detail/operator_safe_bool.hpp>
#include <sstd/boost/contract/detail/declspec.hpp>
...
inline bool copy_old(virtual_* v) {
    ...
    #include <sstd/boost/contract/detail/inlined/old.hpp>
#endif
