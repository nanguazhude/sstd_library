...
#include <sstd/boost/contract/core/exception.hpp> // For set_... (if always in code).
#if !defined(BOOST_CONTRACT_NO_CONDITIONS) || \
        defined(BOOST_CONTRACT_STATIC_LINK)
    #include <sstd/boost/contract/detail/condition/cond_base.hpp>
    #include <sstd/boost/contract/detail/auto_ptr.hpp>
    #include <sstd/boost/contract/detail/debug.hpp>
#endif
#include <sstd/boost/contract/detail/check.hpp>
