...
#include <sstd/boost/atomic/fences.hpp>
#include <sstd/boost/atomic/atomic_flag.hpp>
#include <sstd/boost/atomic/detail/atomic_template.hpp>
#include <sstd/boost/atomic/detail/operations.hpp>
#include <sstd/boost/atomic/detail/extra_operations.hpp>
#if !defined(BOOST_ATOMIC_NO_FLOATING_POINT)
#include <sstd/boost/atomic/detail/fp_operations.hpp>
#include <sstd/boost/atomic/detail/extra_fp_operations.hpp>
#endif
