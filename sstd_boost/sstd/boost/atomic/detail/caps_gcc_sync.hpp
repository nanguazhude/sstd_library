...
#include <sstd/boost/atomic/detail/hwcaps_gcc_x86.hpp>
#elif defined(__arm__)
#include <sstd/boost/atomic/detail/hwcaps_gcc_arm.hpp>
#elif defined(__POWERPC__) || defined(__PPC__)
#include <sstd/boost/atomic/detail/hwcaps_gcc_ppc.hpp>
#endif
