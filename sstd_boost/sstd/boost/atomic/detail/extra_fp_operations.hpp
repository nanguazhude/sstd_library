...
#include <sstd/boost/atomic/detail/extra_fp_ops_generic.hpp>
#include <sstd/boost/atomic/detail/extra_fp_ops_emulated.hpp>

#if !defined(BOOST_ATOMIC_DETAIL_EXTRA_FP_BACKEND_GENERIC)
#include BOOST_ATOMIC_DETAIL_EXTRA_FP_BACKEND_HEADER(sstd/boost/atomic/detail/extra_fp_ops_)
#endif
