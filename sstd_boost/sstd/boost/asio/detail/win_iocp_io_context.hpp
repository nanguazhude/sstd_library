...
#include <sstd/boost/asio/detail/win_iocp_operation.hpp>
#include <sstd/boost/asio/detail/win_iocp_thread_info.hpp>
...
#include <sstd/boost/asio/detail/impl/win_iocp_io_context.hpp>
