...
#include <sstd/boost/asio/ssl/detail/password_callback.hpp>
#include <sstd/boost/asio/ssl/detail/verify_callback.hpp>
...
#include <sstd/boost/asio/ssl/impl/context.hpp>
