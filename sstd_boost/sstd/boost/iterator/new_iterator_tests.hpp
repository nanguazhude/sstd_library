...
# include <sstd/boost/concept_archetype.hpp> // for detail::dummy_constructor
# include <sstd/boost/pending/iterator_tests.hpp>
# include <sstd/boost/iterator/is_readable_iterator.hpp>
# include <sstd/boost/iterator/is_lvalue_iterator.hpp>
