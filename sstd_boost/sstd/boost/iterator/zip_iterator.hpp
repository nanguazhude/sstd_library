...
#include <sstd/boost/iterator/iterator_adaptor.hpp> // for enable_if_convertible
#include <sstd/boost/iterator/iterator_categories.hpp>

#include <sstd/boost/iterator/minimum_category.hpp>

#include <utility> // for std::pair
#include <sstd/boost/fusion/adapted/boost_tuple.hpp> // for backward compatibility
...
#include <sstd/boost/fusion/support/tag_of_fwd.hpp>
