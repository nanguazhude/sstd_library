...
#include <sstd/boost/thread/csbl/memory/pointer_traits.hpp>

// 20.7.4, pointer safety
// 20.7.5, pointer alignment function

// 20.7.6, allocator argument tag
#include <sstd/boost/thread/csbl/memory/allocator_arg.hpp>

// 20.7.8, allocator traits
#include <sstd/boost/thread/csbl/memory/allocator_traits.hpp>

// 20.7.7, uses_allocator
#include <sstd/boost/thread/csbl/memory/scoped_allocator.hpp>
...
// default_delete
#include <sstd/boost/thread/csbl/memory/default_delete.hpp>
