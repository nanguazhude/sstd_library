...
#include <sstd/boost/predef/platform.h>
#include <sstd/boost/throw_exception.hpp>
#include <sstd/boost/assert.hpp>
#include <sstd/boost/thread/exceptions.hpp>
#include <sstd/boost/detail/interlocked.hpp>

#include <sstd/boost/winapi/config.hpp>
#include <sstd/boost/winapi/basic_types.hpp>
#include <sstd/boost/winapi/semaphore.hpp>
#include <sstd/boost/winapi/system.hpp>
#include <sstd/boost/winapi/event.hpp>
#include <sstd/boost/winapi/thread.hpp>
#include <sstd/boost/winapi/get_current_thread.hpp>
#include <sstd/boost/winapi/get_current_thread_id.hpp>
#include <sstd/boost/winapi/get_current_process.hpp>
#include <sstd/boost/winapi/get_current_process_id.hpp>
#include <sstd/boost/winapi/wait.hpp>
#include <sstd/boost/winapi/handles.hpp>
#include <sstd/boost/winapi/access_rights.hpp>

//#include <sstd/boost/winapi/synchronization.hpp>
#include <sstd/boost/thread/win32/interlocked_read.hpp>
#include <algorithm>
