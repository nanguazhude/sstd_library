...
#include <sstd/boost/thread/detail/invoker.hpp>
#include <sstd/boost/thread/detail/invoke.hpp>
#include <sstd/boost/thread/detail/is_convertible.hpp>
#include <sstd/boost/thread/exceptional_ptr.hpp>
#include <sstd/boost/thread/futures/future_error.hpp>
#include <sstd/boost/thread/futures/future_error_code.hpp>
#include <sstd/boost/thread/futures/future_status.hpp>
#include <sstd/boost/thread/futures/is_future_type.hpp>
#include <sstd/boost/thread/futures/launch.hpp>
#include <sstd/boost/thread/futures/wait_for_all.hpp>
#include <sstd/boost/thread/futures/wait_for_any.hpp>
#include <sstd/boost/thread/lock_algorithms.hpp>
#include <sstd/boost/thread/lock_types.hpp>
#include <sstd/boost/thread/mutex.hpp>
#include <sstd/boost/thread/thread_only.hpp>
#include <sstd/boost/thread/thread_time.hpp>
#include <sstd/boost/thread/executor.hpp>
#include <sstd/boost/thread/executors/generic_executor_ref.hpp>

#if defined BOOST_THREAD_FUTURE_USES_OPTIONAL
#include <sstd/boost/optional.hpp>
#else
#include <sstd/boost/thread/csbl/memory/unique_ptr.hpp>
#endif
...
#include <sstd/boost/smart_ptr/make_shared.hpp>
...
#include <sstd/boost/thread/detail/memory.hpp>
#include <sstd/boost/container/scoped_allocator.hpp>
...
#include <sstd/boost/thread/csbl/tuple.hpp>
...
#include <sstd/boost/thread/detail/atomic_undef_macros.hpp>
          if(!atomic_load(&future_))
            {
                future_ptr blank;
                atomic_compare_exchange(&future_,&blank,future_ptr(new detail::shared_state<R>));
            }
#include <sstd/boost/thread/detail/atomic_redef_macros.hpp>
#endif
        }
