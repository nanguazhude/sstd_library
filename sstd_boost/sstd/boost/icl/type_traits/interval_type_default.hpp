...
#include <sstd/boost/icl/discrete_interval.hpp>
#include <sstd/boost/icl/right_open_interval.hpp>
#include <sstd/boost/icl/left_open_interval.hpp>
#include <sstd/boost/icl/closed_interval.hpp>
#include <sstd/boost/icl/open_interval.hpp>
