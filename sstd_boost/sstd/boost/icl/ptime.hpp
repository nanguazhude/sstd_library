...
#ifdef BOOST_MSVC
#pragma warning(push)
#pragma warning(disable:4100) // sstd/boost/date_time/time.hpp(80) : warning C4100: 'as_offset' : unreferenced formal parameter
...
#include <sstd/boost/icl/type_traits/difference_type_of.hpp>
#include <sstd/boost/icl/type_traits/size_type_of.hpp>
