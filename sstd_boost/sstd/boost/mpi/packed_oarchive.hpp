...
#include <sstd/boost/archive/detail/common_oarchive.hpp>
#include <sstd/boost/mpi/detail/packed_oprimitive.hpp>
#include <sstd/boost/mpi/detail/binary_buffer_oprimitive.hpp>
