...
#include <sstd/boost/mpi/exception.hpp>
...
#include <sstd/boost/mpi/skeleton_and_content_fwd.hpp>

// For (de-)serializing arrays
#include <sstd/boost/serialization/array.hpp>

#include <sstd/boost/mpi/detail/point_to_point.hpp>
#include <sstd/boost/mpi/status.hpp>
#include <sstd/boost/mpi/request.hpp>
