...
#include <sstd/boost/exception/detail/error_info_impl.hpp>
#include <sstd/boost/exception/detail/type_info.hpp>
#include <sstd/boost/exception/detail/shared_ptr.hpp>
