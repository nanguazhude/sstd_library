    ...
    #include <sstd/boost/proto/detail/preprocessed/matches_.hpp>
    ...
    #define BOOST_PP_ITERATION_PARAMS_1                                                             \
        (3, (2, BOOST_PP_MAX(BOOST_PROTO_MAX_ARITY, BOOST_PROTO_MAX_LOGICAL_ARITY), <sstd/boost/proto/detail/matches_.hpp>))
