        ...
        #include <sstd/boost/proto/detail/preprocessed/expr_variadic.hpp>
    #else
        #include <sstd/boost/proto/detail/preprocessed/expr.hpp>
    #endif
    ...
    #define BOOST_PP_ITERATION_PARAMS_1                                                         \
        (3, (0, 0, <sstd/boost/proto/detail/expr.hpp>))
    #include BOOST_PP_ITERATE()

    #undef BOOST_PROTO_DEFINE_TERMINAL
    #define BOOST_PP_ITERATION_PARAMS_1                                                         \
        (3, (1, BOOST_PROTO_MAX_ARITY, <sstd/boost/proto/detail/expr.hpp>))
    #include BOOST_PP_ITERATE()
    ...
    // Generate non-variadic versions of expr
        ...
        // The expr<> specializations are actually defined here.
        #define BOOST_PROTO_DEFINE_TERMINAL
        #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, 0, <sstd/boost/proto/detail/expr.hpp>))
        #include BOOST_PP_ITERATE()

        #undef BOOST_PROTO_DEFINE_TERMINAL
        #define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_PROTO_MAX_ARITY, <sstd/boost/proto/detail/expr.hpp>))
        #include BOOST_PP_ITERATE()
    ...
    #define BOOST_PP_ITERATION_PARAMS_2                                                             \
        (3, (1, BOOST_PP_DEC(BOOST_PROTO_MAX_FUNCTION_CALL_ARITY), <sstd/boost/proto/detail/expr_funop.hpp>))
    #include BOOST_PP_ITERATE()
