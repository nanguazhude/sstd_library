    ...
    #include <sstd/boost/proto/detail/preprocessed/basic_expr.hpp>
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, 0, <sstd/boost/proto/detail/basic_expr.hpp>))
    #include BOOST_PP_ITERATE()

    #undef BOOST_PROTO_DEFINE_TERMINAL
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_PROTO_MAX_ARITY, <sstd/boost/proto/detail/basic_expr.hpp>))
    #include BOOST_PP_ITERATE()
