...
#include <sstd/boost/proto/domain.hpp>
#include <sstd/boost/proto/generate.hpp>
...
#include <sstd/boost/proto/detail/poly_function.hpp>
#include <sstd/boost/proto/detail/deprecated.hpp>
...
#define BOOST_PROTO_AS_CHILD(Z, N, DATA)                                                        \
    ...
    namespace detail
    {
        ...
        #include <sstd/boost/proto/detail/unpack_expr_.hpp>

        // Definition of detail::make_expr_
        #include <sstd/boost/proto/detail/make_expr_.hpp>
    }
    ...
    namespace functional
    {
        ...
        struct make_expr
        {
            ...
            #include <sstd/boost/proto/detail/make_expr_funop.hpp>
    ...
    // Additional overloads generated by the preprocessor...
    #include <sstd/boost/proto/detail/make_expr.hpp>
