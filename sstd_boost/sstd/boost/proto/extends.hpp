...
#include <sstd/boost/proto/detail/remove_typename.hpp>
...
namespace boost { namespace proto
{
    ...
    namespace exprns_
    {
        ...
        struct extends
        {
            ...
            #include <sstd/boost/proto/detail/extends_funop_const.hpp>
        };
        ...
        struct extends<Expr, Derived, Domain, 0>
        {
            ...
            // nested preprocessor loops, use file iteration here to generate
            // the operator() overloads, which is more efficient.
            #include <sstd/boost/proto/detail/extends_funop.hpp>
        };
