...
namespace boost { namespace proto
{
    namespace detail
    {
        ...
        struct construct_
        {
            ...
            #include <sstd/boost/proto/transform/detail/construct_funop.hpp>
        };
        ...
        struct construct_<Type, true>
        {
            ...
            // Other overloads generated by the preprocessor
            #include <sstd/boost/proto/transform/detail/construct_pod_funop.hpp>
        };
    ...
    #include <sstd/boost/proto/transform/detail/make.hpp>
    #include <sstd/boost/proto/transform/detail/make_gcc_workaround.hpp>
