    ...
    #include <sstd/boost/proto/transform/detail/preprocessed/pass_through_impl.hpp>
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_PROTO_MAX_ARITY, <sstd/boost/proto/transform/detail/pass_through_impl.hpp>))
