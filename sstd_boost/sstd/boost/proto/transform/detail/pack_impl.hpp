    ...
    #include <sstd/boost/proto/transform/detail/preprocessed/pack_impl.hpp>
    ...
    #define BOOST_PP_ITERATION_PARAMS_1                                                             \
        (3, (0, BOOST_PP_DEC(BOOST_PROTO_MAX_ARITY), <sstd/boost/proto/transform/detail/pack_impl.hpp>))
    #include BOOST_PP_ITERATE()
        ...
        struct BOOST_PP_CAT(expand_pattern_rest_, N)
        {
            ...
            #define BOOST_PP_ITERATION_PARAMS_2                                                     \
                (3, (1, M, <sstd/boost/proto/transform/detail/pack_impl.hpp>))
            #include BOOST_PP_ITERATE()
        };
        #undef M0
        #undef M
