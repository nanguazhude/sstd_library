...
#include <sstd/boost/config.hpp>                     // BOOST_MSVC, template friends,
#include <sstd/boost/detail/workaround.hpp>          // BOOST_NESTED_TEMPLATE
#include <sstd/boost/core/typeinfo.hpp>
#include <sstd/boost/iostreams/constants.hpp>
#include <sstd/boost/iostreams/detail/access_control.hpp>
...
#include <sstd/boost/iostreams/traits.hpp>           // is_filter.
#include <sstd/boost/iostreams/stream_buffer.hpp>
