...
#include <sstd/boost/iostreams/detail/streambuf/direct_streambuf.hpp>
#include <sstd/boost/iostreams/detail/streambuf/indirect_streambuf.hpp>
...
# include <sstd/boost/iostreams/detail/broken_overload_resolution/stream_buffer.hpp>
#else
