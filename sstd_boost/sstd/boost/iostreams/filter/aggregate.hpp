...
#include <vector>
#include <sstd/boost/iostreams/constants.hpp>      // default_device_buffer_size
#include <sstd/boost/iostreams/categories.hpp>
#include <sstd/boost/iostreams/detail/char_traits.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp>     // openmode, streamsize.
#include <sstd/boost/iostreams/pipeline.hpp>
#include <sstd/boost/iostreams/read.hpp>           // check_eof
