...
#include <sstd/boost/config.hpp> // STATIC_CONSTANT, STDC_NAMESPACE,
...
#include <sstd/boost/config.hpp>               // Put size_t in std.
#include <sstd/boost/detail/workaround.hpp>
#include <sstd/boost/cstdint.hpp>              // uint8_t, uint32_t.
#include <sstd/boost/iostreams/checked_operations.hpp>
#include <sstd/boost/iostreams/constants.hpp>  // buffer size.
#include <sstd/boost/iostreams/detail/adapter/non_blocking_adapter.hpp>
#include <sstd/boost/iostreams/detail/adapter/range_adapter.hpp>
#include <sstd/boost/iostreams/detail/char_traits.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp> // failure, streamsize.
...
#include <sstd/boost/iostreams/filter/zlib.hpp>
#include <sstd/boost/iostreams/pipeline.hpp>
#include <sstd/boost/iostreams/putback.hpp>
