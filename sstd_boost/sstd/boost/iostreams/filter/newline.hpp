...
#include <sstd/boost/config.hpp>                // BOOST_STATIC_CONSTANT.
#include <sstd/boost/iostreams/categories.hpp>
#include <sstd/boost/iostreams/detail/char_traits.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp>  // BOOST_IOSTREAMS_FAILURE
#include <sstd/boost/iostreams/read.hpp>        // get
#include <sstd/boost/iostreams/write.hpp>       // put
