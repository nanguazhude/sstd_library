...
#include <sstd/boost/config.hpp>                        // BOOST_DEDUCED_TYPENAME,
#include <sstd/boost/core/typeinfo.hpp>
#include <sstd/boost/iostreams/detail/char_traits.hpp>  // member template friends.
...
#include <sstd/boost/iostreams/detail/streambuf.hpp>
...
// Must come last.
#include <sstd/boost/iostreams/detail/config/disable_warnings.hpp> // MSVC.
