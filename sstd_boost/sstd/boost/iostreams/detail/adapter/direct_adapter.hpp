...
#include <sstd/boost/config.hpp>       // SFINAE, MSVC, put ptrdiff_t in std.
#include <algorithm>              // copy, min.
#include <cstddef>                // ptrdiff_t.
#include <sstd/boost/detail/workaround.hpp>
#include <sstd/boost/iostreams/categories.hpp>
#include <sstd/boost/iostreams/detail/config/limits.hpp>        // forwarding.
#include <sstd/boost/iostreams/detail/config/wide_streams.hpp>  // locale.
#include <sstd/boost/iostreams/detail/double_object.hpp>
#include <sstd/boost/iostreams/detail/error.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp>  // openmode, seekdir, int types.
...
// Must come last.
#include <sstd/boost/iostreams/detail/config/disable_warnings.hpp> // VC7.1
