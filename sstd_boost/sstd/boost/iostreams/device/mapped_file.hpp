...
#include <sstd/boost/iostreams/detail/ios.hpp>     // openmode, failure
#include <sstd/boost/iostreams/detail/path.hpp>
#include <sstd/boost/iostreams/operations_fwd.hpp>
