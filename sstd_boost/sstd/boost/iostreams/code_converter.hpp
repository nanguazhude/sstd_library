...
#include <sstd/boost/iostreams/detail/config/wide_streams.hpp>
...
#include <exception>
#include <sstd/boost/config.hpp>                // DEDUCED_TYPENAME,
#include <sstd/boost/iostreams/char_traits.hpp>
#include <sstd/boost/iostreams/constants.hpp>   // default_filter_buffer_size.
#include <sstd/boost/iostreams/detail/adapter/concept_adapter.hpp>
#include <sstd/boost/iostreams/detail/adapter/direct_adapter.hpp>
#include <sstd/boost/iostreams/detail/buffer.hpp>
#include <sstd/boost/iostreams/detail/call_traits.hpp>
#include <sstd/boost/iostreams/detail/codecvt_holder.hpp>
#include <sstd/boost/iostreams/detail/codecvt_helper.hpp>
#include <sstd/boost/iostreams/detail/double_object.hpp>
#include <sstd/boost/iostreams/detail/execute.hpp>
#include <sstd/boost/iostreams/detail/forward.hpp>
#include <sstd/boost/iostreams/detail/functional.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp> // failure, openmode, int types, streamsize.
#include <sstd/boost/iostreams/detail/optional.hpp>
#include <sstd/boost/iostreams/detail/select.hpp>
#include <sstd/boost/iostreams/traits.hpp>
#include <sstd/boost/iostreams/operations.hpp>
...
// Must come last.
#include <sstd/boost/iostreams/detail/config/disable_warnings.hpp> // Borland 5.x
