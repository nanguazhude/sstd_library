...
#include <sstd/boost/config.hpp>                 // Make sure ptrdiff_t is in std.
#include <algorithm>                        // copy, min.
#include <cstddef>                          // ptrdiff_t.
#include <utility>                          // pair.
#include <sstd/boost/bind.hpp>
#include <sstd/boost/detail/workaround.hpp>
#include <sstd/boost/iostreams/chain.hpp>
...
#include <sstd/boost/iostreams/detail/resolve.hpp>
#include <sstd/boost/iostreams/detail/wrap_unwrap.hpp>
#include <sstd/boost/iostreams/operations.hpp>  // read, write, close.
