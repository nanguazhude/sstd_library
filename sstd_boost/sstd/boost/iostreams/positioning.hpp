...
#include <sstd/boost/iostreams/detail/config/codecvt.hpp> // mbstate_t.
#include <sstd/boost/iostreams/detail/config/fpos.hpp>
#include <sstd/boost/iostreams/detail/ios.hpp> // streamoff, streampos.
