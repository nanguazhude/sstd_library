...
#include <sstd/boost/smart_ptr/bad_weak_ptr.hpp>
#include <sstd/boost/smart_ptr/detail/sp_counted_base.hpp>
#include <sstd/boost/smart_ptr/detail/sp_counted_impl.hpp>
