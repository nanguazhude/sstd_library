...
#include <sstd/boost/test/tools/detail/indirections.hpp>

#include <sstd/boost/test/tools/fpc_tolerance.hpp>
#include <sstd/boost/test/tools/floating_point_comparison.hpp>
