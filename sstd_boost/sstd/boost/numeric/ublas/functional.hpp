...
#include <sstd/boost/numeric/ublas/traits.hpp>
#ifdef BOOST_UBLAS_USE_DUFF_DEVICE
#include <sstd/boost/numeric/ublas/detail/duff.hpp>
#endif
#ifdef BOOST_UBLAS_USE_SIMD
#include <sstd/boost/numeric/ublas/detail/raw.hpp>
#else
namespace boost { namespace numeric { namespace ublas { namespace raw {
}}}}
#endif
#ifdef BOOST_UBLAS_HAVE_BINDINGS
#include <sstd/boost/numeric/bindings/traits/std_vector.hpp>
#include <sstd/boost/numeric/bindings/traits/ublas_vector.hpp>
#include <sstd/boost/numeric/bindings/traits/ublas_matrix.hpp>
#include <sstd/boost/numeric/bindings/atlas/cblas.hpp>
#endif

#include <sstd/boost/numeric/ublas/detail/definitions.hpp>
