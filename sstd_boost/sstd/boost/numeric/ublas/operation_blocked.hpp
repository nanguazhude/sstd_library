...
#include <sstd/boost/numeric/ublas/detail/vector_assign.hpp> // indexing_vector_assign
#include <sstd/boost/numeric/ublas/detail/matrix_assign.hpp> // indexing_matrix_assign
