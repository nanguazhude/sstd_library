...
#include <sstd/boost/coroutine2/coroutine.hpp>
#include <sstd/boost/coroutine2/fixedsize_stack.hpp>
#include <sstd/boost/coroutine2/pooled_fixedsize_stack.hpp>
#include <sstd/boost/coroutine2/protected_fixedsize_stack.hpp>
