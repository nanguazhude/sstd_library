...
# include <mutex>
# include <sstd/boost/fiber/detail/spinlock_ttas_adaptive.hpp>
# include <sstd/boost/fiber/detail/spinlock_ttas.hpp>
# if defined(BOOST_FIBERS_HAS_FUTEX)
#  include <sstd/boost/fiber/detail/spinlock_ttas_adaptive_futex.hpp>
#  include <sstd/boost/fiber/detail/spinlock_ttas_futex.hpp>
# endif
# if defined(BOOST_USE_TSX)
#  include <sstd/boost/fiber/detail/spinlock_rtm.hpp>
# endif
#endif
