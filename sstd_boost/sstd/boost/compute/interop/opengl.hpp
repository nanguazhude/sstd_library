...
#include <sstd/boost/compute/interop/opengl/acquire.hpp>
#include <sstd/boost/compute/interop/opengl/context.hpp>
#include <sstd/boost/compute/interop/opengl/opengl_buffer.hpp>
#include <sstd/boost/compute/interop/opengl/opengl_renderbuffer.hpp>
