...
#include <sstd/boost/beast/websocket/error.hpp>
#include <sstd/boost/beast/websocket/option.hpp>
#include <sstd/boost/beast/websocket/rfc6455.hpp>
#include <sstd/boost/beast/websocket/stream_base.hpp>
#include <sstd/boost/beast/websocket/stream_fwd.hpp>
#include <sstd/boost/beast/websocket/detail/hybi13.hpp>
#include <sstd/boost/beast/websocket/detail/impl_base.hpp>
#include <sstd/boost/beast/websocket/detail/pmd_extension.hpp>
#include <sstd/boost/beast/websocket/detail/prng.hpp>
#include <sstd/boost/beast/core/role.hpp>
#include <sstd/boost/beast/core/stream_traits.hpp>
#include <sstd/boost/beast/core/string.hpp>
#include <sstd/boost/beast/core/detail/type_traits.hpp>
#include <sstd/boost/beast/http/detail/type_traits.hpp>
...
#include <sstd/boost/beast/websocket/impl/stream_impl.hpp> // must be first
#include <sstd/boost/beast/websocket/impl/accept.hpp>
#include <sstd/boost/beast/websocket/impl/close.hpp>
#include <sstd/boost/beast/websocket/impl/handshake.hpp>
#include <sstd/boost/beast/websocket/impl/ping.hpp>
#include <sstd/boost/beast/websocket/impl/read.hpp>
#include <sstd/boost/beast/websocket/impl/stream.hpp>
#include <sstd/boost/beast/websocket/impl/write.hpp>
