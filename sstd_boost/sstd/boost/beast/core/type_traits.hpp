...
#include <sstd/boost/beast/core/detail/is_invocable.hpp>
#include <sstd/boost/config/pragma_message.hpp>
#include <type_traits.hpp>

BOOST_PRAGMA_MESSAGE("<sstd/boost/beast/core/type_traits.hpp> is DEPRECATED and will be removed in a future release.")
