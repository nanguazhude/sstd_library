...
BOOST_PRAGMA_MESSAGE("<sstd/boost/beast/core/handler_ptr.hpp> is DEPRECATED and will be removed in a future release.")
...
#include <sstd/boost/beast/core/impl/handler_ptr.hpp>
