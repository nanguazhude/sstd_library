...
#include <sstd/boost/math/special_functions/log1p.hpp> // for log (1 + x)
#include <sstd/boost/math/constants/constants.hpp> // For exp_minus_one == 3.67879441171442321595523770161460867e-01.
#include <sstd/boost/math/special_functions/pow.hpp> // powers with compile time exponent, used in arbitrary precision code.
#include <sstd/boost/math/tools/series.hpp> // series functor.
//#include <sstd/boost/math/tools/polynomial.hpp>  // polynomial.
#include <sstd/boost/math/tools/rational.hpp>  // evaluate_polynomial.
#include <sstd/boost/mpl/int.hpp>
#include <sstd/boost/type_traits/is_integral.hpp>
#include <sstd/boost/math/tools/precision.hpp> // boost::math::tools::max_value().
...
#include <iostream>
#include <typeinfo>
#include <sstd/boost/math/special_functions/next.hpp>  // For float_distance.
...
#include <sstd/boost/math/special_functions/detail/lambert_w_lookup_table.ipp>
