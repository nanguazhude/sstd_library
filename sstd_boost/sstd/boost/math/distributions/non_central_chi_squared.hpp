...
#include <sstd/boost/math/distributions/fwd.hpp>
#include <sstd/boost/math/special_functions/gamma.hpp> // for incomplete gamma. gamma_q
#include <sstd/boost/math/special_functions/bessel.hpp> // for cyl_bessel_i
#include <sstd/boost/math/special_functions/round.hpp> // for iround
#include <sstd/boost/math/distributions/complement.hpp> // complements
#include <sstd/boost/math/distributions/chi_squared.hpp> // central distribution
#include <sstd/boost/math/distributions/detail/common_error_handling.hpp> // error checks
#include <sstd/boost/math/special_functions/fpclassify.hpp> // isnan.
#include <sstd/boost/math/tools/roots.hpp> // for root finding.
#include <sstd/boost/math/distributions/detail/generic_mode.hpp>
