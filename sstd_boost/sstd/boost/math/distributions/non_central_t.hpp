...
#include <sstd/boost/math/distributions/non_central_beta.hpp> // for nc beta
#include <sstd/boost/math/distributions/normal.hpp> // for normal CDF and quantile
#include <sstd/boost/math/distributions/students_t.hpp>
#include <sstd/boost/math/distributions/detail/generic_quantile.hpp> // quantile
