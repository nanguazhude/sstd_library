// sstd\boost\math\distributions\binomial.hpp
...
#include <sstd/boost/math/special_functions/beta.hpp> // for incomplete beta.
...
#include <sstd/boost/math/distributions/detail/inv_discrete_quantile.hpp> // error checks
