...
#pragma once
#endif
#include <sstd/boost/multiprecision/detail/number_base.hpp> // test for multiprecision types.
#include <sstd/boost/type_traits/is_complex.hpp> // test for complex types
