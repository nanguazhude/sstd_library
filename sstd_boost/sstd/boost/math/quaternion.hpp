...
#include <sstd/boost/config.hpp> // for BOOST_NO_STD_LOCALE
#include <sstd/boost/math_fwd.hpp>
...
#include <sstd/boost/math/special_functions/sinc.hpp>    // for the Sinus cardinal
#include <sstd/boost/math/special_functions/sinhc.hpp>    // for the Hyperbolic Sinus cardinal
