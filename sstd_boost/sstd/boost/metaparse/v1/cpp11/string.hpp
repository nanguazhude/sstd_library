...
#include <sstd/boost/metaparse/v1/cpp11/fwd/string.hpp>
#include <sstd/boost/metaparse/v1/string_tag.hpp>
#include <sstd/boost/metaparse/v1/impl/string_iterator.hpp>
#include <sstd/boost/metaparse/v1/cpp11/impl/empty_string.hpp>
#include <sstd/boost/metaparse/v1/cpp11/impl/size.hpp>
#include <sstd/boost/metaparse/v1/cpp11/impl/pop_front.hpp>
#include <sstd/boost/metaparse/v1/cpp11/impl/push_front_c.hpp>
#include <sstd/boost/metaparse/v1/cpp11/impl/push_back_c.hpp>
#include <sstd/boost/metaparse/v1/cpp11/impl/pop_back.hpp>
#include <sstd/boost/metaparse/v1/cpp11/impl/string_at.hpp>
...
#  else
#    include <sstd/boost/metaparse/v1/cpp11/impl/string.hpp>
#  endif
#else
#  include <sstd/boost/metaparse/v1/cpp11/impl/string.hpp>
#endif
