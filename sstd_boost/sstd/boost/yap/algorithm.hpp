...
#include <sstd/boost/yap/algorithm_fwd.hpp>
#include <sstd/boost/yap/user_macros.hpp>
#include <sstd/boost/yap/detail/algorithm.hpp>
...
#include <sstd/boost/yap/detail/transform.hpp>
