...
static const std::pair<fs::path, fs::path>
   specials[] = {
      ...
      std::pair<fs::path, fs::path>("sstd/boost/atomic/capabilities.hpp", "boost/atomic/detail"),
      std::pair<fs::path, fs::path>("sstd/boost/chrono/chrono.hpp", "libs/chrono/src"),
      std::pair<fs::path, fs::path>("sstd/boost/chrono/chrono.hpp", "libs/chrono/build"),
      std::pair<fs::path, fs::path>("sstd/boost/context/execution_context.hpp", "libs/context/src"),
      std::pair<fs::path, fs::path>("sstd/boost/context/execution_context.hpp", "libs/context/build"),
      std::pair<fs::path, fs::path>("sstd/boost/context/fcontext.hpp", "libs/context/src"),
      std::pair<fs::path, fs::path>("sstd/boost/context/fcontext.hpp", "libs/context/build"),
      std::pair<fs::path, fs::path>("sstd/boost/context/fixedsize_stack.hpp", "libs/context/src"),
      std::pair<fs::path, fs::path>("sstd/boost/context/fixedsize_stack.hpp", "libs/context/build"),
      std::pair<fs::path, fs::path>("sstd/boost/context/protected_fixedsize_stack.hpp", "libs/context/src"),
      std::pair<fs::path, fs::path>("sstd/boost/context/protected_fixedsize_stack.hpp", "libs/context/build"),
      std::pair<fs::path, fs::path>("sstd/boost/context/segmented_stack.hpp", "libs/context/src"),
      std::pair<fs::path, fs::path>("sstd/boost/context/segmented_stack.hpp", "libs/context/build"),
      std::pair<fs::path, fs::path>("sstd/boost/context/stack_context.hpp", "libs/context/src"),
      std::pair<fs::path, fs::path>("sstd/boost/context/stack_context.hpp", "libs/context/build"),
      std::pair<fs::path, fs::path>("sstd/boost/context/stack_traits.hpp", "libs/context/src"),
      std::pair<fs::path, fs::path>("sstd/boost/context/stack_traits.hpp", "libs/context/build"),
      std::pair<fs::path, fs::path>("sstd/boost/cerrno.hpp", "libs/system/build"),
      std::pair<fs::path, fs::path>("sstd/boost/cerrno.hpp", "libs/system/src"),
      std::pair<fs::path, fs::path>("libs/thread/build", "sstd/boost/system"),
      std::pair<fs::path, fs::path>("libs/thread/build", "sstd/boost/cerrno.hpp"),
      std::pair<fs::path, fs::path>("libs/thread/build", "sstd/boost/chrono"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem/convenience.hpp", "boost/filesystem.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem/exception.hpp", "boost/filesystem.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem/fstream.hpp", "boost/filesystem.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem/operations.hpp", "boost/filesystem.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem/path.hpp", "boost/filesystem.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem.hpp", "libs/filesystem/build"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem.hpp", "libs/filesystem/v2"),
      std::pair<fs::path, fs::path>("sstd/boost/filesystem.hpp", "libs/filesystem/v3"),
      std::pair<fs::path, fs::path>("sstd/boost/config.hpp", "boost/config"),
      ...
      std::pair<fs::path, fs::path>("sstd/boost/preprocessor/iterate.hpp", "boost/preprocessor/iteration"),
      std::pair<fs::path, fs::path>("sstd/boost/preprocessor/slot/slot.hpp", "boost/preprocessor/slot/detail"),
      std::pair<fs::path, fs::path>("sstd/boost/function.hpp", "boost/function/detail"),
      std::pair<fs::path, fs::path>("sstd/boost/regex/config.hpp", "boost/regex/user.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/signals/signal_template.hpp", "boost/function"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/list.hpp", "boost/mpl/list"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/list_c.hpp", "boost/mpl/list"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/vector.hpp", "boost/mpl/vector"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/deque.hpp", "boost/mpl/vector"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/vector_c.hpp", "boost/mpl/vector"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/map.hpp", "boost/mpl/map"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/set.hpp", "boost/mpl/set"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/set_c.hpp", "boost/mpl/set"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/aux_/include_preprocessed.hpp", "boost/mpl/aux_/preprocessed"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/vector/aux_/include_preprocessed.hpp", "boost/mpl/vector/aux_/preprocessed"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/set/aux_/include_preprocessed.hpp", "boost/mpl/set/aux_/preprocessed"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/map/aux_/include_preprocessed.hpp", "boost/mpl/map/aux_/preprocessed"),
      std::pair<fs::path, fs::path>("sstd/boost/mpl/list/aux_/include_preprocessed.hpp", "boost/mpl/list/aux_/preprocessed"),
      std::pair<fs::path, fs::path>("libs/graph/src/python/visitor.hpp", "libs/graph/src/python"),
      std::pair<fs::path, fs::path>("sstd/boost/test/detail/config.hpp", "libs/test/src"),
      std::pair<fs::path, fs::path>("sstd/boost/test/detail/config.hpp", "libs/test/build"),
      std::pair<fs::path, fs::path>("sstd/boost/typeof.hpp", "boost/typeof/incr_registration_group.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/function_types/detail/pp_loop.hpp", "boost/function_types/detail/pp_cc_loop"),
      std::pair<fs::path, fs::path>("sstd/boost/function_types/components.hpp", "boost/function_types/detail/components_impl"),
      std::pair<fs::path, fs::path>("sstd/boost/function_types/detail/pp_loop.hpp", "boost/function_types/detail"),
      std::pair<fs::path, fs::path>("sstd/boost/math/tools/rational.hpp", "boost/math/tools/detail"),
      std::pair<fs::path, fs::path>("sstd/boost/proto/repeat.hpp", "boost/proto/detail/local.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/signals/signal_template.hpp", "boost/function"),
      std::pair<fs::path, fs::path>("sstd/boost/preprocessor/slot/counter.hpp", "boost/preprocessor/slot/detail/counter.hpp"),
      std::pair<fs::path, fs::path>("sstd/boost/graph/distributed/detail/tag_allocator.hpp", "libs/graph_parallel"),
      std::pair<fs::path, fs::path>("sstd/boost/graph/distributed/mpi_process_group.hpp", "libs/graph_parallel"),
   };
...
void bcp_implementation::add_file_dependencies(const fs::path& p, bool scanfile)
{
   ...
   static const std::string known_macros[] = {
      ...
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/aux_/preprocessed/AUX778076_PREPROCESSED_HEADER)",
      "BOOST_USER_CONFIG",
      ...
      "BOOST_ABI_PREFIX",
      "BOOST_ABI_SUFFIX",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/aux_/preprocessed/AUX_PREPROCESSED_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/list/AUX778076_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/list/AUX778076_LIST_C_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/list/AUX778076_LIST_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/map/aux_/preprocessed/AUX778076_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/map/AUX778076_MAP_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/set/aux_/preprocessed/AUX778076_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/set/AUX778076_SET_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/set/AUX778076_SET_C_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/vector/AUX778076_VECTOR_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/vector/aux_/preprocessed/AUX778076_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/vector/AUX778076_DEQUE_HEADER)",
      "BOOST_PP_STRINGIZE(sstd/boost/mpl/vector/AUX778076_VECTOR_C_HEADER)",
